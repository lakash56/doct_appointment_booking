...
<html class="no-js" lang="en">
    <head>
        ...
        <title>E-Doct Appointment System</title>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                          ...
                          {{-- <button type="button" class="nav-link ml-10" id="apps_modal_btn" data-toggle="modal" data-target="#appsModal"><i class="ik ik-grid"></i></button> --}}
                            <div class="dropdown">
                                <strong>Welcome, {{strtoupper(Auth()->user()->name)}}</strong>
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="images/{{auth()->user()->image}}" alt=""></a>
