    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <div class="card">
                    <div class="card-header"><h3>Doctor List</h3></div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a href="#"> <a href="#" data-toggle="modal" data-target="#exampleModal{{$user->id}}"><i class="ik ik-eye"></i></a>
