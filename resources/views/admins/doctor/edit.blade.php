                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       {{-- from image multipart/fomr-data in enctype --}}
                        <form class="form-sample" action="{{route('doctor.update',[$user->id])}}" method="post" enctype="multipart/form-data">@csrf
                            {{-- in resourseful routing need to add method --}}
                            @method('PUT')
                            <div class="row">
                                {{-- Name --}}
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="degree" class="form-control @error('degree') is-invalid @enderror" placeholder="Degree"  value="{{$user->degree}}">
                                    {{-- error validation --}}
                                    @error('degree')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{-- <input type="text" name="department" class="form-control @error('department') is-invalid @enderror" placeholder="Department"  value="{{$user->department}}"> --}}
                                    <select class="form-control" name="department">
                                        @foreach (App\Models\Department::all() as $department )
                                        <option value="{{$department->department}}">
                                            @if ($user->department==$department->department)selected
